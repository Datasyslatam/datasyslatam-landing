...
const HeroSection = () => {
  ...
  // Parallax: el scroll desplaza la imagen hacia arriba sutilmente
  ...
  return (
    ...
    >
      {/* ── 1. Imagen de fondo con Ken Burns + Parallax ── */}
      <motion.div
        className="absolute inset-0 w-full h-full"
        style={{
          zIndex: 0,
          // Parallax: se desplaza en Y al hacer scroll (desactivado si prefiere menos movimiento)
          y: shouldReduceMotion ? 0 : parallaxY,
          // Escala ligeramente mayor para que el parallax no deje huecos
      ...
      >
        <motion.img
          ...
          // Ken Burns: zoom lento + drift diagonal sobre ~20 segundos, loop infinito
          animate={
            shouldReduceMotion
              ? {}
              : {
